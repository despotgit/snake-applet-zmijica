       ...
       implements KeyListener,ActionListener
{
    ...
    int smer=39;  /* u pocetku zmija ide na desno */
    int smertmp=39;
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(varijos==0)
        {
            ...
            switch(smertmp)
            {
            case 38 :nova=new Kocka(glavax,glavay-1);
                     kocke.add(nova);
            ...
            case 40 :nova=new Kocka(glavax,glavay+1);
                     kocke.add(nova);
                     if (gulp()) {serve=true;varijos+=worth*jelo;}
                     brisix=((Kocka)kocke.get(0)).x;
                     brisiy=((Kocka)kocke.get(0)).y;
            ...
            case 37 :nova=new Kocka(glavax-1,glavay);
                     kocke.add(nova);
                     if (gulp()) {serve=true;varijos+=worth*jelo;}
                     brisix=((Kocka)kocke.get(0)).x;
                     brisiy=((Kocka)kocke.get(0)).y;
            ...
            case 39 :nova=new Kocka(glavax+1,glavay);
                     kocke.add(nova);
                     if (gulp()) {serve=true;varijos+=worth*jelo;}
                     brisix=((Kocka)kocke.get(0)).x;
                     brisiy=((Kocka)kocke.get(0)).y;
