       ...
       implements KeyListener,ActionListener
{
    ...
    public void paint(Graphics g)
    {
        ...
        g2=(Graphics2D)g;
        g2.setStroke(stroke);
        if (zazid==0) {crtajzid(g2);zazid=1;}
        ...
        if (kuc())
        {
            ...
            for(int i=0;i<kocke.size();i++) stare.add((Kocka)kocke.get(i));          
            jelo=1;
    ...
    public void novojelo(Graphics2D gr2,int broj)
    {
      ...
      if (broj>910) gr2.setFont(new Font("Arial",Font.BOLD,9));
